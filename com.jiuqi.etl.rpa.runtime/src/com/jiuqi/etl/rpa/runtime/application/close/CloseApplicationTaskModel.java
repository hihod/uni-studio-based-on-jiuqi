 ...
 * @author liangxiao01
 */
public class CloseApplicationTaskModel extends TaskModel {
	...
	@Override
	public CloseApplicationTaskModel clone() {
		CloseApplicationTaskModel cloned = (CloseApplicationTaskModel) super.clone();
	...
	@Override
	public String getId() {
		return CloseApplicationTaskFactory.ID;
	}
