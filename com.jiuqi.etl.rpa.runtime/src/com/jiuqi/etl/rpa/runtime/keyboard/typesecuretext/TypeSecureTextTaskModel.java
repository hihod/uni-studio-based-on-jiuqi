 ...
 * @author liangxiao01
 */
public class TypeSecureTextTaskModel extends TaskModel {
	...
	@Override
	public String getId() {
		return TypeSecureTextTaskFactory.ID;
	}

	public TypeSecureTextTaskModel clone() {
		TypeSecureTextTaskModel cloned = (TypeSecureTextTaskModel) super.clone();
