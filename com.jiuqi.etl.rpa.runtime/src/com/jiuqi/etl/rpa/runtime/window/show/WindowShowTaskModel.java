 ...
 * @author liangxiao01
 */
public class WindowShowTaskModel extends TaskModel {
	...
	@Override
	public String getId() {
		return WindowShowTaskFactory.ID;
	}

	public WindowShowTaskModel clone() {
		WindowShowTaskModel cloned = (WindowShowTaskModel) super.clone();
