...
public class WindowRestoreTaskModel extends TaskModel {
	...
	@Override
	public String getId() {
		return WindowRestoreTaskFactory.ID;
	}

	public WindowRestoreTaskModel clone() {
		WindowRestoreTaskModel cloned = (WindowRestoreTaskModel) super.clone();
