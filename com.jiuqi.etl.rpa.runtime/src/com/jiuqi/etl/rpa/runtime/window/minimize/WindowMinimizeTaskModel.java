...
public class WindowMinimizeTaskModel extends TaskModel {
	...
	@Override
	public String getId() {
		return WindowMinimizeTaskFactory.ID;
	}

	public WindowMinimizeTaskModel clone() {
		WindowMinimizeTaskModel cloned = (WindowMinimizeTaskModel) super.clone();
