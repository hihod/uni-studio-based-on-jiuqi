...
public class WindowCloseTaskModel extends TaskModel {
	...
	@Override
	public String getId() {
		return WindowCloseTaskFactory.ID;
	}

	public WindowCloseTaskModel clone() {
		WindowCloseTaskModel cloned = (WindowCloseTaskModel) super.clone();
