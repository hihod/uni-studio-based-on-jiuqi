 ...
 * @author liangxiao01
 */
public class WindowHideTaskModel extends TaskModel {
	...
	@Override
	public String getId() {
		return WindowHideTaskFactory.ID;
	}

	public WindowHideTaskModel clone() {
		WindowHideTaskModel cloned = (WindowHideTaskModel) super.clone();
