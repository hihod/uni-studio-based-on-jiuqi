 ...
 * @author liangxiao01
 */
public class MouseDbclickTaskModel extends TaskModel {
	...
	@Override
	public String getId() {
		return MouseDbclickTaskFactory.ID;
	}

	public MouseDbclickTaskModel clone() {
		MouseDbclickTaskModel cloned = (MouseDbclickTaskModel) super.clone();
