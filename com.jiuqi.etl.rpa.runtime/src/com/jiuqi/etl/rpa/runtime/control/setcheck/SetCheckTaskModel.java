 ...
 * @author liangxiao01
 */
public class SetCheckTaskModel extends TaskModel {
	...
	protected void loadFromJson(JSONObject e, Context context) throws ETLModelException {
		JSONObject obj = e;
		this.check = obj.optBoolean(ATTR_CHECK);
	...
	@Override
	public String getId() {
		return SetCheckTaskFactory.ID;
	}
	public SetCheckTaskModel clone() {
		SetCheckTaskModel cloned = (SetCheckTaskModel) super.clone();
