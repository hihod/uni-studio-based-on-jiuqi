...
import com.jiuqi.rpa.action.control.selectItem.SelectItemAction;
import com.jiuqi.rpa.action.control.selectItem.SelectItemInput;
import com.jiuqi.rpa.lib.Context;
import com.jiuqi.rpa.lib.IUIHandler;

public final class SelectItemTaskRunner implements ITaskRunner {
	private SelectItemTaskModel taskModel;
	private Env env;
	public SelectItemTaskRunner(SelectItemTaskModel taskModel) {
	...
	public void run(Env env) throws TaskConditionException, ETLEngineException {
		...
		SelectItemInput actionInput = toActionInput(taskModel);
		SelectItemAction action = new SelectItemAction(actionInput);
		try {
	...
	private SelectItemInput toActionInput(SelectItemTaskModel model) throws ETLEngineException{
		SelectItemInput selectItemInput = new SelectItemInput();
		selectItemInput.setItem(env.parseExpr(model.getItem()));
		...
		selectItemInput.setTarget(target);
		...
		selectItemInput.setDelay(delay);
		return selectItemInput;
	}
