 ...
 * @author liangxiao01
 */
public class ExistsTaskModel extends TaskModel {
	...
	@Override
	public String getId() {
		return ExistsTaskFactory.ID;
	}

	public ExistsTaskModel clone() {
		ExistsTaskModel cloned = (ExistsTaskModel) super.clone();
