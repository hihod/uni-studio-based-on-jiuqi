package com.jiuqi.etl.rpa.ui.window.close;
...
import com.jiuqi.etl.rpa.runtime.window.close.WindowCloseTaskModel;
...
public class WindowCloseProperty implements IPropertySource {

	private WindowCloseTaskModel model;
	...
	public WindowCloseProperty(TaskContext context) {
		this.model = (WindowCloseTaskModel) context.getTaskModel();
