package com.jiuqi.etl.rpa.ui.window.show;
...
import com.jiuqi.etl.rpa.runtime.window.show.WindowShowTaskModel;
...
public class WindowShowProperty implements IPropertySource {

	private WindowShowTaskModel model;
	...
	public WindowShowProperty(TaskContext context) {
		this.model = (WindowShowTaskModel) context.getTaskModel();
