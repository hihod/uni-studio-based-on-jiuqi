package com.jiuqi.etl.rpa.ui.window.maximize;
...
import com.jiuqi.etl.rpa.runtime.window.maximize.WindowMaximizeTaskModel;
...
public class WindowMaximizeProperty implements IPropertySource {

	private WindowMaximizeTaskModel model;
	...
	public WindowMaximizeProperty(TaskContext context) {
		this.model = (WindowMaximizeTaskModel) context.getTaskModel();
