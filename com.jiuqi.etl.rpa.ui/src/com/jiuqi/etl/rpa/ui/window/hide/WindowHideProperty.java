package com.jiuqi.etl.rpa.ui.window.hide;
...
import com.jiuqi.etl.rpa.runtime.window.hide.WindowHideTaskModel;
...
public class WindowHideProperty implements IPropertySource {

	private WindowHideTaskModel model;
	...
	public WindowHideProperty(TaskContext context) {
		this.model = (WindowHideTaskModel) context.getTaskModel();
