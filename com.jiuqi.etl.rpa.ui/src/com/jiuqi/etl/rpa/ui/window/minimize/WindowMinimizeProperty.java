package com.jiuqi.etl.rpa.ui.window.minimize;
...
import com.jiuqi.etl.rpa.runtime.window.minimize.WindowMinimizeTaskModel;
...
public class WindowMinimizeProperty implements IPropertySource {

	private WindowMinimizeTaskModel model;
	...
	public WindowMinimizeProperty(TaskContext context) {
		this.model = (WindowMinimizeTaskModel) context.getTaskModel();
