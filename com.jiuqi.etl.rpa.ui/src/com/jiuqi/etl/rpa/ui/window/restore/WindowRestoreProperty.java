package com.jiuqi.etl.rpa.ui.window.restore;
...
import com.jiuqi.etl.rpa.runtime.window.restore.WindowRestoreTaskModel;
...
public class WindowRestoreProperty implements IPropertySource {

	private WindowRestoreTaskModel model;
	...
	public WindowRestoreProperty(TaskContext context) {
		this.model = (WindowRestoreTaskModel) context.getTaskModel();
