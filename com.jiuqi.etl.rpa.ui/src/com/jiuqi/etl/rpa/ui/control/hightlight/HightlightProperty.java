package com.jiuqi.etl.rpa.ui.control.hightlight;
...
import com.jiuqi.etl.rpa.runtime.ColorPackage;
import com.jiuqi.etl.rpa.runtime.control.hightlight.HightlightTaskModel;
...
public class HightlightProperty implements IPropertySource {

	private HightlightTaskModel model;
	...
	private static final String KEY_HIGHTLIGHT_TIME = "高亮时间";
	private static final String KEY_HIGHRLIGHT_COLOR = "高亮颜色";
	public HightlightProperty(TaskContext context) {
		this.model = (HightlightTaskModel) context.getTaskModel();
		...
		ComboBoxPropertyDescriptor hightLightColor = new ComboBoxPropertyDescriptor(KEY_HIGHRLIGHT_COLOR, KEY_HIGHRLIGHT_COLOR, ColorPackage.getTitleArray());
		EditableComboPropertyDescriptor hightLightTime = new EditableComboPropertyDescriptor(KEY_HIGHTLIGHT_TIME, KEY_HIGHTLIGHT_TIME,integerParamStrs);
		hightLightTime.setValidator(numberValidate);
		hightLightTime.setCategory("选项");
		hightLightColor.setCategory("选项");
		pds = new IPropertyDescriptor[]{/*目标*/targetParam,picker,targetDelay,
										/*输出*/hightLightTime,hightLightColor};
	...
	public Object getPropertyValue(Object id) {
		...
		} else if(id.equals(KEY_HIGHTLIGHT_TIME)) {
			return String.valueOf(this.model.getHightlightTime());
		}else if(id.equals(KEY_HIGHRLIGHT_COLOR)) {
			int index = ColorPackage.getIndex(this.model.getHightlightColor());
			return index;
		}
		return null;
	}
	...
	public void setPropertyValue(Object id, Object value) {
		if(id.equals(KEY_TARGETPARAM)) {
			...
			this.model.setHightlightTime((String) value);
		} else if(id.equals(KEY_HIGHRLIGHT_COLOR)) {
			this.model.setHightlightColor(ColorPackage.getValueArray()[((Integer) value)]);
		}
	}
