package com.jiuqi.etl.rpa.ui.control.selectitem;
...
import com.jiuqi.etl.rpa.runtime.control.selectitem.SelectItemTaskModel;
...
public class SelectItemProperty implements IPropertySource {

	private SelectItemTaskModel model;
	...
	private static final String KEY_ITEM = "条目";
	public SelectItemProperty(TaskContext context) {
		this.model = (SelectItemTaskModel) context.getTaskModel();
		...
		TextPropertyDescriptor item = new TextPropertyDescriptor(KEY_ITEM, KEY_ITEM);
		item.setCategory("输入");
		item.setDescription("需要选择的条目内容");
	...
	public Object getPropertyValue(Object id) {
		...
		} else if(id.equals(KEY_ITEM)) {
			if(StringUtils.isNotEmpty(this.model.getItem())){
	...
	public void setPropertyValue(Object id, Object value) {
		if(id.equals(KEY_DELAYBEFORE)) {
			...
			this.model.setItem((String) value);
		} else if(id.equals(KEY_TARGETPARAM)) {
