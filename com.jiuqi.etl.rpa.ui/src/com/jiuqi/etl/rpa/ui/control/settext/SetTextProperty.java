...
import com.jiuqi.etl.rpa.runtime.control.settext.SetTextTaskModel;
...
public class SetTextProperty implements IPropertySource {

	private SetTextTaskModel model;
	...
	private static final String KEY_TEXT = "输入文本";
	public SetTextProperty(TaskContext context) {
		this.model = (SetTextTaskModel) context.getTaskModel();
		...
		TextPropertyDescriptor inputText = new TextPropertyDescriptor(KEY_TEXT, KEY_TEXT);
	...
	public Object getPropertyValue(Object id) {
		if(id.equals(KEY_DELAYBEFORE)) {
			...
			return String.valueOf(this.model.getText());
	...
	public void setPropertyValue(Object id, Object value) {
		if(id.equals(KEY_DELAYBEFORE)) {
			...
			this.model.setText((String) value);
		} else if(id.equals(KEY_TARGETPARAM)) {
