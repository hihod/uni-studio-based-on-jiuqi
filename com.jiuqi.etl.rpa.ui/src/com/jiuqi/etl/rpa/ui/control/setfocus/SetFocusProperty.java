package com.jiuqi.etl.rpa.ui.control.setfocus;
...
import com.jiuqi.etl.rpa.runtime.control.setfocus.SetFocusTaskModel;
...
public class SetFocusProperty implements IPropertySource {

	private SetFocusTaskModel model;
	...
	public SetFocusProperty(TaskContext context) {
		this.model = (SetFocusTaskModel) context.getTaskModel();
