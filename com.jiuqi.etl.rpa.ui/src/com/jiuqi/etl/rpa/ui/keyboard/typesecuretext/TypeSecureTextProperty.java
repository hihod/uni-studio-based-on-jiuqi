...
import com.jiuqi.etl.rpa.runtime.keyboard.typesecuretext.TypeSecureTextTaskModel;
...
public class TypeSecureTextProperty implements IPropertySource {

	private TypeSecureTextTaskModel model;
	String getSecureText(){
	...
	public TypeSecureTextProperty(TaskContext context) {
		this.model = (TypeSecureTextTaskModel) context.getTaskModel();
		...
		SecureTextPropertyDescriptor textInput = new SecureTextPropertyDescriptor(KEY_EXPRESSION,KEY_EXPRESSION);
	...
	public void setPropertyValue(Object id, Object value) {
		if(id.equals(KEY_TYPEMODEL)) {
			...
			if("".equals((String) value)){
				...
				this.model.setExpression(JqLib.encodePassword(secureText,secureText.length()));				
			}
		} else if(id.equals(KEY_CLEAR_BEFORE_TYPE)) {
			if((Integer)value ==0){
