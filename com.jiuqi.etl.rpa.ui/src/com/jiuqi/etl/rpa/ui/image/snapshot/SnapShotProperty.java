...
public class SnapShotProperty implements IPropertySource {
	...
	private static final String KEY_IMAGE_DATA = "图像";
	private static final String KEY_FILE_PATH = "输出路径";
	public SnapShotProperty(TaskContext context) {
		...
		filePath.setCategory("输入");
		imageData.setCategory("输出");
