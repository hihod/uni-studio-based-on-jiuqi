package com.jiuqi.etl.rpa.ui.application.close;
...
import com.jiuqi.etl.rpa.runtime.application.close.CloseApplicationTaskModel;
...
public class CloseApplicationProperty implements IPropertySource {
	private CloseApplicationTaskModel model;
	...
	public CloseApplicationProperty(TaskContext context) {
		this.model = (CloseApplicationTaskModel) context.getTaskModel();
		...
		UIPickerPopupPropertyDescriptor picker = new UIPickerPopupPropertyDescriptor(KEY_PATHPICKER, KEY_PATHPICKER,
				this.model.getTaskTarget(), true);
		...
		pds = new IPropertyDescriptor[] { /* 输入 */targetParam, picker, targetDelay };
	...
	public Object getPropertyValue(Object id) {
		if (id.equals(KEY_TARGETPARAM)) {
			...
			if (this.model.getTaskTarget().getPath() == null) {
				return "<未配置>";
			}
			return "<已配置>";
